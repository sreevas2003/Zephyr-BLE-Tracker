...
procpu_dram0_org = ((1073405952) + 0x2000) + 0xdb5c;
procpu_dram0_len = (((1073405952) + (204800)) - ((1073405952) + 0x2000)) - 0xdb5c;
...
stepper_drv_driver_api_area : ALIGN_WITH_INPUT { _stepper_drv_driver_api_list_start = .; KEEP(*(SORT_BY_NAME(._stepper_drv_driver_api.static.*))); _stepper_drv_driver_api_list_end = .;; } > drom0_0_seg AT > FLASH
